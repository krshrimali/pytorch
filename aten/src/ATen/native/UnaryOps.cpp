...
static inline Tensor& unary_op_impl_out(Tensor& result, const Tensor& self, Stub& stub, bool promote=true) {
  auto iter = TensorIterator::unary_op(result, self,
    /*check_mem_overlap=*/true, /*promote=*/promote);
...
Tensor& acos_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) { 
  if(promote) return unary_op_impl_out(result, self, acos_stub, bool(promote)); 
  else return unary_op_impl_out(result, self, acos_stub);
}
...
Tensor& asin_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) { 
  if(promote) return unary_op_impl_out(result, self, asin_stub, bool(promote));
  else return unary_op_impl_out(result, self, asin_stub);
}
...
Tensor& abs_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) { 
  if(promote) return unary_op_impl_out(result, self, abs_stub, bool(promote));
  else return unary_op_impl_out(result, self, abs_stub);
}
...
Tensor& angle_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) { 
  if(promote) return unary_op_impl_out(result, self, angle_stub, bool(promote));
  else return unary_op_impl_out(result, self, angle_stub);
}
Tensor angle(const Tensor& self) { return unary_op_impl(self, at::angle_out); }

Tensor& real_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) { 
  if(promote) return unary_op_impl_out(result, self, real_stub, bool(promote));
  else return unary_op_impl_out(result, self, real_stub);
}
Tensor real(const Tensor& self) { return unary_op_impl(self, at::real_out); }

Tensor& imag_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, imag_stub, bool(promote));
  else return unary_op_impl_out(result, self, imag_stub);
}
Tensor imag(const Tensor& self) { return unary_op_impl(self, at::imag_out); }

Tensor& conj_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, conj_stub, bool(promote));
  else return unary_op_impl_out(result, self, conj_stub);
}
Tensor conj(const Tensor& self) { return unary_op_impl(self, at::conj_out); }

Tensor& bitwise_not_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, bitwise_not_stub, bool(promote));
  else return unary_op_impl_out(result, self, bitwise_not_stub);
}
...
Tensor& ceil_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) { 
  if(promote) return unary_op_impl_out(result, self, ceil_stub, bool(promote));
  else return unary_op_impl_out(result, self, ceil_stub);
}
Tensor ceil(const Tensor& self) { return unary_float_op_impl(self, at::ceil_out); }
Tensor& ceil_(Tensor& self) { return unary_op_impl_(self, at::ceil_out); }

Tensor& expm1_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, expm1_stub, bool(promote));
  else return unary_op_impl_out(result, self, expm1_stub);
}
Tensor expm1(const Tensor& self) { return unary_float_op_impl(self, at::expm1_out); }
Tensor& expm1_(Tensor& self) { return unary_op_impl_(self, at::expm1_out); }

Tensor& frac_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, frac_stub, bool(promote));
  else return unary_op_impl_out(result, self, frac_stub);
}
...
Tensor& floor_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) { 
  if(promote) return unary_op_impl_out(result, self, floor_stub, bool(promote));
  else return unary_op_impl_out(result, self, floor_stub);
}
Tensor floor(const Tensor& self) { return unary_float_op_impl(self, at::floor_out); }
Tensor& floor_(Tensor& self) { return unary_op_impl_(self, at::floor_out); }

Tensor& log_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, log_stub, bool(promote));
  else return unary_op_impl_out(result, self, log_stub);
}
Tensor log(const Tensor& self) { return unary_float_op_impl(self, at::log_out); }
Tensor& log_(Tensor& self) { return unary_op_impl_(self, at::log_out); }

Tensor& log10_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, log10_stub, bool(promote));
  else return unary_op_impl_out(result, self, log10_stub);
}
Tensor log10(const Tensor& self) { return unary_float_op_impl(self, at::log10_out); }
Tensor& log10_(Tensor& self) { return unary_op_impl_(self, at::log10_out); }

Tensor& log1p_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, log1p_stub, bool(promote));
  else return unary_op_impl_out(result, self, log1p_stub);
}
Tensor log1p(const Tensor& self) { return unary_float_op_impl(self, at::log1p_out); }
Tensor& log1p_(Tensor& self) { return unary_op_impl_(self, at::log1p_out); }

Tensor& log2_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, log2_stub, bool(promote));
  else return unary_op_impl_out(result, self, log2_stub);
}
Tensor log2(const Tensor& self) { return unary_float_op_impl(self, at::log2_out); }
Tensor& log2_(Tensor& self) { return unary_op_impl_(self, at::log2_out); }

Tensor& round_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, round_stub, bool(promote));
  else return unary_op_impl_out(result, self, round_stub);
}
...
Tensor& digamma_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, digamma_stub, bool(promote));
  else return unary_op_impl_out(result, self, digamma_stub);
}
Tensor digamma(const Tensor& self) { return unary_op_impl(self, at::digamma_out); }
Tensor& digamma_(Tensor& self) { return unary_op_impl_(self, at::digamma_out); }

Tensor& reciprocal_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, reciprocal_stub, bool(promote));
  else return unary_op_impl_out(result, self, reciprocal_stub);
}
...
Tensor& rsqrt_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, rsqrt_stub, bool(promote));
  else return unary_op_impl_out(result, self, rsqrt_stub);
}
...
Tensor& sign_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, sign_stub, bool(promote));
  else return unary_op_impl_out(result, self, sign_stub);
}
...
Tensor& sin_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, sin_stub, bool(promote));
  else return unary_op_impl_out(result, self, sin_stub);
}
Tensor sin(const Tensor& self) { return unary_float_op_impl(self, at::sin_out); }
Tensor& sin_(Tensor& self) { return unary_op_impl_(self, at::sin_out); }

Tensor& sinh_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, sinh_stub, bool(promote));
  else return unary_op_impl_out(result, self, sinh_stub);
}
Tensor sinh(const Tensor& self) { return unary_float_op_impl(self, at::sinh_out); }
Tensor& sinh_(Tensor& self) { return unary_op_impl_(self, at::sinh_out); }

Tensor& sqrt_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, sqrt_stub, bool(promote));
  else return unary_op_impl_out(result, self, sqrt_stub);
}
Tensor sqrt(const Tensor& self) { return unary_float_op_impl(self, at::sqrt_out); }
...
Tensor& sigmoid_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, sigmoid_stub, bool(promote));
  else return unary_op_impl_out(result, self, sigmoid_stub);
}
...
Tensor& trunc_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  if(promote) return unary_op_impl_out(result, self, trunc_stub, bool(promote));
  else return unary_op_impl_out(result, self, trunc_stub);
}
Tensor trunc(const Tensor& self) { return unary_float_op_impl(self, at::trunc_out); }
Tensor& trunc_(Tensor& self) { return unary_op_impl_(self, at::trunc_out); }

Tensor& neg_out(Tensor& result, const Tensor& self, c10::optional<bool> promote) {
  TORCH_CHECK(self.scalar_type() != kBool,
              "Negation, the `-` operator, on a bool tensor is not supported. "
              "If you are trying to invert a mask, use the `~` or `logical_not()` operator instead.");
  if(promote) return unary_op_impl_out(result, self, neg_stub, bool(promote));
  else return unary_op_impl_out(result, self, neg_stub);
}
...
#define IMPLEMENT_UNARY_FLOATING_OP_CORE(op)                           \
  Tensor op(const Tensor& self, c10::optional<bool>promote) {                                      \
    Tensor result = isIntegralType(self.scalar_type(), /*include_bool=*/ true) ? \
      at::empty({0}, self.options().dtype(typeMetaToScalarType(c10::get_default_dtype()))) : \
      at::empty({0}, self.options()); \
    if(promote) at::op##_out(result, self.to(result.scalar_type()), promote); \
    return at::op##_out(result, self.to(result.scalar_type()));               \
    return result;                                                     \
  }

#define IMPLEMENT_UNARY_OP_OUT_INPLACE(op, prefix, device)             \
  Tensor& _##op##__##prefix(Tensor& self, c10::optional<bool>promote) {                            \
    if(promote) return at::op##_out(self, self, promote); \
    else return at::op##_out(self, self);                                   \
  }                                                                    \
  Tensor& _##op##_out_##prefix(Tensor& result, const Tensor& self, c10::optional<bool> promote) {   \
    checkDeviceType(#op, result, DeviceType::device);                  \
    checkLayout(#op, result, Layout::Strided);                         \
    if(promote) { \
      auto iter = TensorIterator::unary_op(result, self, true, bool(promote)); \
